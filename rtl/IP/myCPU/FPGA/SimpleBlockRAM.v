module SimpleBlockRAM(
  ...
  input  [3:0]  io_wr_addr, // @[src/main/scala/util/BlockRAM.scala 63:14]
  input  [62:0] io_wr_data, // @[src/main/scala/util/BlockRAM.scala 63:14]
  input         io_rd_en, // @[src/main/scala/util/BlockRAM.scala 63:14]
  input  [3:0]  io_rd_addr, // @[src/main/scala/util/BlockRAM.scala 63:14]
  output [62:0] io_rd_data // @[src/main/scala/util/BlockRAM.scala 63:14]
);
  wire  blackbox_clka; // @[src/main/scala/util/BlockRAM.scala 106:26]
  wire  blackbox_wea; // @[src/main/scala/util/BlockRAM.scala 106:26]
  wire [3:0] blackbox_addra; // @[src/main/scala/util/BlockRAM.scala 106:26]
  wire [62:0] blackbox_dina; // @[src/main/scala/util/BlockRAM.scala 106:26]
  ...
  wire [3:0] blackbox_addrb; // @[src/main/scala/util/BlockRAM.scala 106:26]
  wire [62:0] blackbox_doutb; // @[src/main/scala/util/BlockRAM.scala 106:26]
  BlockRAM_16x63 blackbox ( // @[src/main/scala/util/BlockRAM.scala 106:26]
    .clka(blackbox_clka),
    .wea(blackbox_wea),
