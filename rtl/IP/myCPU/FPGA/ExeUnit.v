module ExeUnit(
  ...
  output [13:0] io_csrRaddr, // @[src/main/scala/backend/execute/ExeUnit.scala 46:14]
  input  [31:0] io_csrRdata, // @[src/main/scala/backend/execute/ExeUnit.scala 46:14]
  input  [31:0] io_timerInfo_tid, // @[src/main/scala/backend/execute/ExeUnit.scala 46:14]
  input  [63:0] io_timerInfo_timer // @[src/main/scala/backend/execute/ExeUnit.scala 46:14]
);
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] csrUnit_io_uop_ctrl_csrOp; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire  csrUnit_io_uop_ctrl_csrWen; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire [31:0] csrUnit_io_rs1; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire [31:0] csrUnit_io_rs2; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire [31:0] csrUnit_io_csrRdata; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire [31:0] csrUnit_io_result; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire  csrUnit_io_csrWen; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire [31:0] csrUnit_io_csrWdata; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire [31:0] csrUnit_io_timerInfo_tid; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  wire [63:0] csrUnit_io_timerInfo_timer; // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  ...
  wire  csrValid = stgValid & stgData_uop_ctrl_fuType == 4'h4; // @[src/main/scala/backend/execute/ExeUnit.scala 132:46]
  ...
  CSRUnit csrUnit ( // @[src/main/scala/backend/execute/ExeUnit.scala 133:43]
  ...
  assign io_outResult_bits_csrWen = csrValid & csrUnit_io_csrWen; // @[src/main/scala/backend/execute/ExeUnit.scala 193:51]
  assign io_outResult_bits_csrWaddr = csrValid ? stgData_uop_csrAddress : 14'h0; // @[src/main/scala/backend/execute/ExeUnit.scala 194:25]
  assign io_outResult_bits_csrWdata = csrValid ? csrUnit_io_csrWdata : 32'h0; // @[src/main/scala/backend/execute/ExeUnit.scala 195:25]
  assign io_outResult_bits_csrTimer = csrValid ? csrUnit_io_timerInfo_timer : 64'h0; // @[src/main/scala/backend/execute/ExeUnit.scala 196:25]
  assign io_csrRaddr = csrValid ? stgData_uop_csrAddress : 14'h0; // @[src/main/scala/backend/execute/ExeUnit.scala 148:21]
  ...
  assign csrUnit_io_uop_ctrl_csrOp = stgData_uop_ctrl_csrOp; // @[src/main/scala/backend/execute/ExeUnit.scala 136:25]
  assign csrUnit_io_uop_ctrl_csrWen = stgData_uop_ctrl_csrWen; // @[src/main/scala/backend/execute/ExeUnit.scala 136:25]
  assign csrUnit_io_rs1 = stgData_rs1Data; // @[src/main/scala/backend/execute/ExeUnit.scala 137:25]
  assign csrUnit_io_rs2 = stgData_rs2Data; // @[src/main/scala/backend/execute/ExeUnit.scala 138:25]
  assign csrUnit_io_csrRdata = io_csrRdata; // @[src/main/scala/backend/execute/ExeUnit.scala 139:25]
  assign csrUnit_io_timerInfo_tid = io_timerInfo_tid; // @[src/main/scala/backend/execute/ExeUnit.scala 140:26]
  assign csrUnit_io_timerInfo_timer = io_timerInfo_timer; // @[src/main/scala/backend/execute/ExeUnit.scala 140:26]
