...
module MSHREntry(
  ...
  input  [19:0]  io_req_bits_victimTag, // @[src/main/scala/memory/dcache/MSHREntry.scala 16:14]
  ...
  output [2:0]   io_ar_bits_arsize, // @[src/main/scala/memory/dcache/MSHREntry.scala 16:14]
  ...
  output [19:0]  io_refillTag, // @[src/main/scala/memory/dcache/MSHREntry.scala 16:14]
  ...
  output [5:0]   io_setIdx, // @[src/main/scala/memory/dcache/MSHREntry.scala 16:14]
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [19:0] reqVictimTag; // @[src/main/scala/memory/dcache/MSHREntry.scala 69:31]
  ...
  wire [5:0] setIdx = reqPaddr[11:6]; // @[src/main/scala/memory/dcache/MSHREntry.scala 77:27]
  ...
  wire [1:0] _io_ar_bits_arsize_T_2 = 4'h1 == reqLsuOp ? 2'h0 : 2'h2; // @[src/main/scala/memory/dcache/MSHREntry.scala 180:29]
  wire [1:0] _io_ar_bits_arsize_T_4 = 4'h7 == reqLsuOp ? 2'h0 : _io_ar_bits_arsize_T_2; // @[src/main/scala/memory/dcache/MSHREntry.scala 180:29]
  wire [1:0] _io_ar_bits_arsize_T_6 = 4'h2 == reqLsuOp ? 2'h1 : _io_ar_bits_arsize_T_4; // @[src/main/scala/memory/dcache/MSHREntry.scala 180:29]
  wire [1:0] _io_ar_bits_arsize_T_8 = 4'h8 == reqLsuOp ? 2'h1 : _io_ar_bits_arsize_T_6; // @[src/main/scala/memory/dcache/MSHREntry.scala 180:29]
  wire [1:0] _io_ar_bits_arsize_T_10 = 4'h3 == reqLsuOp ? 2'h2 : _io_ar_bits_arsize_T_8; // @[src/main/scala/memory/dcache/MSHREntry.scala 180:29]
  wire [1:0] _io_ar_bits_arsize_T_11 = _io_ar_valid_T_1 ? _io_ar_bits_arsize_T_10 : 2'h2; // @[src/main/scala/memory/dcache/MSHREntry.scala 179:28]
  wire  _T_19 = io_ar_ready & io_ar_valid; // @[src/main/scala/chisel3/util/Decoupled.scala 57:35]
  wire [3:0] _GEN_35 = _io_ar_valid_T & _T_19 ? 4'h5 : _GEN_34; // @[src/main/scala/memory/dcache/MSHREntry.scala 194:{45,53}]
  wire [3:0] _GEN_36 = _io_ar_valid_T_1 & _T_19 ? 4'h9 : _GEN_35; // @[src/main/scala/memory/dcache/MSHREntry.scala 195:{45,53}]
  wire  _io_r_ready_T = state == 4'h5; // @[src/main/scala/memory/dcache/MSHREntry.scala 198:23]
  wire  _io_r_ready_T_1 = state == 4'h9; // @[src/main/scala/memory/dcache/MSHREntry.scala 198:47]
  wire  _T_25 = io_r_ready & io_r_valid; // @[src/main/scala/chisel3/util/Decoupled.scala 57:35]
  wire [3:0] _GEN_54 = io_r_bits_rlast ? 4'h6 : _GEN_36; // @[src/main/scala/memory/dcache/MSHREntry.scala 202:{27,51}]
  wire [3:0] _GEN_72 = _io_r_ready_T & _T_25 ? _GEN_54 : _GEN_36; // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
  wire [3:0] _GEN_74 = _io_r_ready_T_1 & _T_25 ? 4'hd : _GEN_72; // @[src/main/scala/memory/dcache/MSHREntry.scala 204:{39,77}]
  ...
  assign io_ar_bits_arsize = {{1'd0}, _io_ar_bits_arsize_T_11}; // @[src/main/scala/memory/dcache/MSHREntry.scala 179:22]
  assign io_r_ready = state == 4'h5 | state == 4'h9; // @[src/main/scala/memory/dcache/MSHREntry.scala 198:38]
  ...
  assign io_refillTag = reqPaddr[31:12]; // @[src/main/scala/memory/dcache/MSHREntry.scala 78:27]
  ...
  assign io_setIdx = reqPaddr[11:6]; // @[src/main/scala/memory/dcache/MSHREntry.scala 77:27]
  ...
  always @(posedge clock) begin
    ...
    end else if (_io_done_T_1 & io_release) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 211:43]
      state <= 4'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 211:51]
    end else if (_io_done_T & io_release) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 210:43]
      state <= 4'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 210:51]
    end else if (_io_refillWriteReq_T & io_refillWriteAck) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 207:55]
      state <= 4'h7; // @[src/main/scala/memory/dcache/MSHREntry.scala 207:63]
    end else begin
      state <= _GEN_74;
    end
    ...
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 69:31]
      reqVictimTag <= 20'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 69:31]
    end else if (_T) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 96:21]
    ...
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (io_r_bits_rlast) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 202:27]
        beatCnt <= 5'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 202:37]
      end else begin
        beatCnt <= _beatCnt_T_1; // @[src/main/scala/memory/dcache/MSHREntry.scala 201:13]
      end
    ...
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      ...
      if (4'h0 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_0 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_1 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h1 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_1 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_2 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h2 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_2 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_3 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h3 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_3 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_4 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h4 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_4 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_5 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h5 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_5 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_6 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h6 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_6 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_7 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h7 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_7 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_8 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h8 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_8 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_9 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'h9 == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_9 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_10 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'ha == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_10 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_11 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'hb == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_11 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_12 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'hc == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_12 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_13 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'hd == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_13 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_14 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'he == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_14 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    if (reset) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
      refillBuf_15 <= 32'h0; // @[src/main/scala/memory/dcache/MSHREntry.scala 74:31]
    end else if (_io_r_ready_T & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 199:43]
      if (4'hf == beatCnt[3:0]) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
        refillBuf_15 <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 200:24]
      end
    end
    ...
    end else if (_io_r_ready_T_1 & _T_25) begin // @[src/main/scala/memory/dcache/MSHREntry.scala 204:39]
      ucDataReg <= io_r_bits_rdata; // @[src/main/scala/memory/dcache/MSHREntry.scala 204:51]
    end
  end
